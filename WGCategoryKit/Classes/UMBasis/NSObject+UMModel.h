 ...
 */
+ (nullable instancetype)um_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)um_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)um_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)um_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)um_modelToJSONObject;
 ...
 */
- (nullable NSData *)um_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)um_modelToJSONString;
 ...
 */
- (void)um_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)um_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)um_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (UMModel)
 ...
 */
+ (nullable NSDictionary *)um_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<UMModel>' to your class header.
 */
@protocol UMModel <NSObject>
@optional
